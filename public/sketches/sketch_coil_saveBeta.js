...
function setup() {
  ...
  waveSpeedSlider = createSlider(0, 0.1, 0.01, 0.01);
...
function draw() {
  ...
  for (var k = 0; k < ribbonCount; k++) {
    ...
    for (
      ...
      var postWave =
        sinEngine(postEcho, waveCount, waveSpeed, slope) * waveSize;
