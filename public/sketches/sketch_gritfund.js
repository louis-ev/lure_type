...
function setup() {
  ...
  zoomCameraSlider = createSlider(-800, 800, 0);
  ...
  presetWobbly = createButton('Wobbly');
  presetWobbly.position(140, height - 50);
  presetWobbly.mousePressed(wobblySet);
  presetDriftin = createButton("Driftin'");
  presetDriftin.position(200, height - 50);
  presetDriftin.mousePressed(driftinSet);
  presetSkyDancer = createButton('Sky Dancer');
  presetSkyDancer.position(260, height - 50);
  presetSkyDancer.mousePressed(skydancerSet);
  presetFlag1 = createButton('Flag1');
  presetFlag1.position(345, height - 50);
  presetFlag1.mousePressed(flag1Set);
  presetFlag2 = createButton('Flag2');
  presetFlag2.position(395, height - 50);
  presetFlag2.mousePressed(flag2Set);
  presetLava = createButton('Lava');
  presetLava.position(445, height - 50);
  presetLava.mousePressed(lavaSet);
  presetWeavin = createButton("Weavin'");
  presetWeavin.position(140, height - 30);
  presetWeavin.mousePressed(weavinSet);
  presetPopNLock = createButton("Pop n' Lock");
  presetPopNLock.position(200, height - 30);
  presetPopNLock.mousePressed(popnlockSet);
  presetShuffle = createButton('Shuffle');
  presetShuffle.position(280, height - 30);
  presetShuffle.mousePressed(shuffleSet);
  presetRollin = createButton("Rollin'");
  presetRollin.position(340, height - 30);
  presetRollin.mousePressed(rollinSet);
  presetWiggle = createButton('Wiggle');
  presetWiggle.position(395, height - 30);
  presetWiggle.mousePressed(wiggleSet);
  presetGritFund = createButton('Grit Fund');
  presetGritFund.position(455, height - 30);
  presetGritFund.mousePressed(gritfundSet);
...
function draw() {
  ...
  if (keyIsPressed) {
    columnSlider.value(inpText.length);
  }
...
function reSetting() {
  ...
  xWaveCheck.checked(false);
  yWaveCheck.checked(false);
  zWaveCheck.checked(false);
...
function wobblySet() {
  ...
  typeX = 72;
  typeY = 94;
  columnSlider.value(13);
  rowSlider.value(4);
  trackingSlider.value(14);
  lineSpaceSlider.value(41);
  typeStrokeSlider.value(4.8);
  xOffset = 5.1;
  yOffset = 0.1;
  speedSlider.value(1);
  zWaveSlider.value(103);
  zWaveCheck.checked(true);
  xWaveSlider.value(10);
  yWaveSlider.value(32);
  yWaveCheck.checked(true);
  xRotCameraSlider.value(4);
  yRotCameraSlider.value(52);
  zRotCameraSlider.value(-2);
...
function driftinSet() {
  ...
  typeX = 84;
  typeY = 94;
  columnSlider.value(5);
  rowSlider.value(5);
  trackingSlider.value(15);
  lineSpaceSlider.value(39);
  ...
  yWaveSlider.value(0);
  xRotCameraSlider.value(8);
  yRotCameraSlider.value(44);
  zRotCameraSlider.value(8);
  zoomCameraSlider.value(-165);
  radioBkgd.value('7');
  radioStroke.value('1');
...
function skydancerSet() {
  ...
  typeX = 84 * 0.8;
  typeY = 94 * 0.8;
  columnSlider.value(8);
  rowSlider.value(4);
  trackingSlider.value(15);
  lineSpaceSlider.value(42);
  ...
  xRotCameraSlider.value(-36);
  yRotCameraSlider.value(8);
...
function flag1Set() {
  ...
  typeX = 72;
  typeY = 94;
  columnSlider.value(10);
  rowSlider.value(3);
  trackingSlider.value(12);
  lineSpaceSlider.value(66);
  typeStrokeSlider.value(4.74);
  xOffset = 8.1;
  yOffset = 2.51;
  speedSlider.value(-2);
  zWaveSlider.value(135);
  zWaveCheck.checked(true);
  xWaveSlider.value(16);
  yWaveSlider.value(20);
  xRotCameraSlider.value(58);
  yRotCameraSlider.value(-24);
  zRotCameraSlider.value(16);
  zoomCameraSlider.value(-245);
  radioBkgd.value('7');
  radioStroke.value('1');
...
function flag2Set() {
  ...
  typeX = 80;
  typeY = 95;
  columnSlider.value(12);
  rowSlider.value(4);
  trackingSlider.value(14);
  lineSpaceSlider.value(35);
  typeStrokeSlider.value(4.74);
  xOffset = 12.1;
  yOffset = 2.51;
  speedSlider.value(-2);
  ...
  xRotCameraSlider.value(28);
  yRotCameraSlider.value(42);
  zRotCameraSlider.value(-8);
  zoomCameraSlider.value(-355);
  radioBkgd.value('2');
  radioStroke.value('1');
...
function lavaSet() {
  ...
  xWaveSlider.value(18);
  xWaveCheck.checked(true);
  yWaveSlider.value(42.4);
  xRotCameraSlider.value(-30);
  yRotCameraSlider.value(14);
  zRotCameraSlider.value(2);
  zoomCameraSlider.value(-500);
  radioBkgd.value('5');
  radioStroke.value('1');
...
function weavinSet() {
  ...
  rowSlider.value(5);
  trackingSlider.value(14);
  lineSpaceSlider.value(43);
  typeStrokeSlider.value(4.74);
  xOffset = 3.73;
  yOffset = 0.1;
  speedSlider.value(-1.5);
  zWaveSlider.value(141);
  zWaveCheck.checked(true);
  xWaveSlider.value(0);
  yWaveSlider.value(24.2);
  xRotCameraSlider.value(50);
  yRotCameraSlider.value(48);
  zRotCameraSlider.value(-44);
  zoomCameraSlider.value(-420);
  radioBkgd.value('6');
  radioStroke.value('1');
...
function popnlockSet() {
  ...
  typeX = 70 * 0.8;
  typeY = 104 * 0.8;
  columnSlider.value(17);
  rowSlider.value(3);
  trackingSlider.value(15);
  lineSpaceSlider.value(33);
  typeStrokeSlider.value(4.74);
  xOffset = 3.71;
  yOffset = 1.31;
  ...
  yWaveSlider.value(40);
  yWaveCheck.checked(true);
  xRotCameraSlider.value(10);
  yRotCameraSlider.value(-22);
  zRotCameraSlider.value(6);
  zoomCameraSlider.value(-500);
  radioBkgd.value('1');
  radioStroke.value('2');
...
function rollinSet() {
  ...
  xRotCameraSlider.value(52);
  yRotCameraSlider.value(30);
  zRotCameraSlider.value(-24);
  zoomCameraSlider.value(-95);
  radioBkgd.value('4');
  radioStroke.value('1');
...
function wiggleSet() {
  ...
  rowSlider.value(3);
  trackingSlider.value(12);
  lineSpaceSlider.value(65);
  typeStrokeSlider.value(4.34);
  xOffset = 1.31;
  yOffset = 0.1;
  speedSlider.value(1);
  zWaveSlider.value(54);
  xWaveSlider.value(20);
  xWaveCheck.checked(true);
  yWaveSlider.value(36);
  xRotCameraSlider.value(26);
  yRotCameraSlider.value(16);
  zRotCameraSlider.value(-16);
  zoomCameraSlider.value(-165);
  radioBkgd.value('5');
  radioStroke.value('1');
...
function gritfundSet() {
  ...
  columnSlider.value(5);
  rowSlider.value(2);
  trackingSlider.value(20);
  lineSpaceSlider.value(18);
  ...
  yRotCameraSlider.value(-58);
  zRotCameraSlider.value(20);
  zoomCameraSlider.value(0);
  radioBkgd.value('1');
  radioStroke.value('2');
